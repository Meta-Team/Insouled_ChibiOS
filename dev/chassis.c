...
void chassis_ctrl() {
    switch (global_mode) {
        ...
        case
            ...
            chassis.motor_speed[0] = (-chassis.vx - chassis.vy + chassis.w * rotate_ratio) * rpm_ratio;
            chassis.motor_speed[1] = (chassis.vx - chassis.vy + chassis.w * rotate_ratio) * rpm_ratio;
            chassis.motor_speed[2] = (chassis.vx + chassis.vy + chassis.w * rotate_ratio) * rpm_ratio;
            chassis.motor_speed[3] = (-chassis.vx + chassis.vy + chassis.w * rotate_ratio) * rpm_ratio;
